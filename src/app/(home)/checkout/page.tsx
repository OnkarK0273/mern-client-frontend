                    ...
                    <DialogContent className="sm:max-w-[425px] p-4">
                      ...
                      <div className="grid gap-4 py-4">
                        <div>
                          ...
                          <Textarea className="mt-2 border-gray-400" />
                        </div>
                      </div>
                      <DialogFooter>
            ...
            <div className="grid gap-3">
              ...
              <RadioGroup className="flex gap-6">
                <div className="w-36">
                  ...
                  <Label
                    htmlFor={"card"}
                    className="flex items-center justify-center rounded-md border-2 bg-card p-2 h-16 hover:bg-accent hover:text-accent-foreground peer-data-[state=checked]:border-primary [&:has([data-state=checked])]:border-primary"
                  >
                    <CreditCard size={"20"} />
